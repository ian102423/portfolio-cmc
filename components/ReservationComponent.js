...
class Reservation extends Component {
    ...
    async obtainNotificationPermission() { // server side notification
        const permission = await Permissions.getAsync(Permissions.USER_FACING_NOTIFICATIONS); // await keyword only can used inside async function
    ...
    async presentLocalNotification(date) { // local notification
